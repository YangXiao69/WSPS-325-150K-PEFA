...
void DS18B20_DATA_OUT(uint8_t i,uint8_t value)
{
    if(i == 1)
    {
        GPIO_WriteBit(DS18B20_PORT, DS18B20_PIN, (BitAction)value);
    }
    else if(i == 2)
    {
        GPIO_WriteBit(GPIOE, GPIO_Pin_5, (BitAction)value);
    }
    else if(i == 3)
    {
        GPIO_WriteBit(GPIOE, GPIO_Pin_6, (BitAction)value);
    }    
    else if(i == 4)
    {
        GPIO_WriteBit(GPIOC, GPIO_Pin_13, (BitAction)value);
    }    
}
...
uint8_t DS18B20_DATA_IN(uint8_t i)
{
    ...
    if(i == 1)
    {
        value = GPIO_ReadInputDataBit(DS18B20_PORT, DS18B20_PIN);
    }
    else if(i == 2)
    {
        value = GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_5);
    }  
    else if(i == 3)
    {
        value = GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_6);
    }     
    else if(i == 4)
    {
