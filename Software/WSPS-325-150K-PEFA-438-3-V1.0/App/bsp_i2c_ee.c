 ...
 * @version    V1.00
 * @date       2021-01-05
 * @brief      i2c EEPROM(AT24C02)interface
 * @attention
 *
 *
 *
...
uint8_t I2c_Buf_Write[DATA_Size] = {0};
uint8_t I2c_Buf_Read[DATA_Size] = {0};
 ...
 ******************************************************************************
 */
void I2C_EE_BufferWrite(__IO uint8_t *pBuffer, uint8_t WriteAddr, uint16_t NumByteToWrite)
{
 ...
 ******************************************************************************
 */
uint32_t I2C_EE_ByteWrite(__IO uint8_t *pBuffer, uint8_t WriteAddr)
{
    ...
    status = HAL_I2C_Mem_Write(&I2C_Handle, EEPROM_ADDRESS, (uint16_t)WriteAddr, I2C_MEMADD_SIZE_8BIT, WriteBuff, 1, 100);
 ...
 ******************************************************************************
 */
uint32_t I2C_EE_PageWrite(__IO uint8_t *pBuffer, uint8_t WriteAddr, uint8_t NumByteToWrite)
{
    HAL_StatusTypeDef status = HAL_OK;
 ...
 ******************************************************************************
 */
uint32_t I2C_EE_BufferRead(__IO uint8_t *pBuffer, uint8_t ReadAddr, uint16_t NumByteToRead)
{
    HAL_StatusTypeDef status = HAL_OK;
